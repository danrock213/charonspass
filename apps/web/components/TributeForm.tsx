...
interface TributeFormProps {
  initialData: Tribute;
  onSubmit: (updated: Tribute) => void;
  submitLabel?: string;
}

export default function TributeForm({ initialData, onSubmit, submitLabel = "Save Tribute" }: TributeFormProps) {
  const router = useRouter();
  const [formData, setFormData] = useState<Tribute>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label className="block mb-1 font-medium text-[#1D3557]">Name<span className="text-red-600">*</span></label>
        <input
          name="name"
          value={formData.name}
      ...
      <div className="flex space-x-4">
        <div className="flex-1">
          <label className="block mb-1 font-medium text-[#1D3557]">Birth Date<span className="text-red-600">*</span></label>
          <input
            type="date"
            name="birthDate"
        ...
        <div className="flex-1">
          <label className="block mb-1 font-medium text-[#1D3557]">Death Date<span className="text-red-600">*</span></label>
          <input
            type="date"
            name="deathDate"
      ...
      <div>
        <label className="block mb-1 font-medium text-[#1D3557]">Obituary<span className="text-red-600">*</span></label>
        <textarea
          name="obituary"
